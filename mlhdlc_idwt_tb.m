%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% MATLAB test bench for the 8-point IDWT
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
clc;
clear mlhdlc_idwt;
...
% Calculating DWT of the input signals for transmission
for ii=1:n
...
% Calculating IDWT to recover original signals
for ii=1:n
    temp_y = y_out(ii*N-N+1:ii*N);
    temp_x = mlhdlc_idwt(temp_y);
    x_out = [x_out temp_x];
end
